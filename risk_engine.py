...
DEFAULT_MAX_TRADES_PER_DAY = None  # TESTING MODE: no artificial daily trade-count cap
DEFAULT_MAX_CONSECUTIVE_LOSSES = None  # TESTING MODE: do not stop after N losses
...
def evaluate_risk_state(closed_trades, capital,
    ...
    blocks = []
    if max_trades_per_day is not None and today_trade_count >= max_trades_per_day:
