...
def _live_dashboard():
    ...
    if df is not None and not df.empty:
        ...
        # Gemini is OFF for this auto-refreshing report entirely
        # (use_ai=False) -- it costs zero API quota this way, since it
        # regenerates every 30s along with the rest of the dashboard.
        # All Gemini quota is reserved for the chat box below, which you
        # can ask on-demand for a live, AI-written trade read anytime.
        # -------------------------------------------------------------
        st.markdown("<br>", unsafe_allow_html=True)
