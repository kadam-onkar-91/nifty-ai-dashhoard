...
# Native auto-refresh (no external package -- streamlit_autorefresh wasn't
# installing on this Python version, so this replaces it with a plain
# browser meta-refresh tag that reloads the page every 30 seconds, same
# effective behavior with zero extra dependencies).
