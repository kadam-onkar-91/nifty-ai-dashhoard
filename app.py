...
# OPTIONAL: last-resort fallback if every Gemini model's free daily quota
# runs out. If not set, the dashboard AI chat still works fine on Gemini
# alone -- this just adds extra headroom on busy days. Get a free key at
# https://console.groq.com and add GROQ_API_KEY to secrets.toml to enable.
