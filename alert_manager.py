...
class AlertManager:
    ...
    # =====================================================================
    # RE-ADDED — these two methods were missing from this deployed copy,
    # even though app.py already calls evaluate_and_send_confluence_alert()
    # every refresh -- that mismatch is exactly what caused the
    # AttributeError. Nothing above this line was touched.
    # =====================================================================
